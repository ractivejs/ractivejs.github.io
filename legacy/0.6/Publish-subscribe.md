...
Note that returning `false` has a duel purpose of both cancelling the view hierarchy [event bubbling](Event bubbling.md) __as well as__ cancelling the DOM Event if the event was DOM-based.
