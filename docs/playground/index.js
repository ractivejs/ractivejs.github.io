(function (Ractive$1) {
  ...
  function init$1(template, css) {
    ...
    if (params.hidemenu) { Ractive$1.styleSet('shell.sides.initialTimeout', 1); }
      ...
      data: function data() {
        return {
          ...
          inCode: function inCode() {
            ...
            var tab$$1 = document.querySelector('[data-script-tab]');
            var inCode = this.get('other.inCode');
            var files = this.get('unit.fs');
            return files && (!tab$$1 || (inCode && tab$$1));
          },
          templates: {
