Ractive.components.Tabs = Ractive.extend({
  ...
  css: ".ractive-tabs { position: absolute; top: 0; bottom: 0; left: 0; right: 0; box-sizing: border-box; } ul { list-style: none; margin: 0; padding: 0; } li { margin: 0; padding: 0; } .ractive-tabs .rt-tabs { height: 3em; box-shadow: 0 2px 2px 0 rgba(0,0,0,0.14), 0 1px 5px 0 rgba(0,0,0,0.12), 0 3px 1px -2px rgba(0,0,0,0.2); box-sizing: border-box; } .ractive-tabs .rt-tab { display: inline-block; padding: 0.75em 1.25em; font-size: 1.2em; height: 100%; box-sizing: border-box; color: rgba(114, 157, 42, 0.8); cursor: pointer; vertical-align: top; } .ractive-tabs .rt-tab-active { border-bottom: 2px solid #729d34; color: #729d34; } .ractive-tabs .rt-tab-disabled { color: #ccc; cursor: not-allowed; } .ractive-tabs .rt-tab-right { float: right; } .ractive-tabs .rt-contents { height: calc(100% - 3.2em); position: absolute; top: 3.2em; width: 100%; overflow: auto; } .ractive-tabs .rt-content { display: none; margin: 0.5em; } .ractive-tabs .rt-content-active { display: block; }",
